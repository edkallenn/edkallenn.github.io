...
* **Atualmente exerce o cargo de Policial Federal** (*Agente de Polícia Federal*) na Superintendência da Polícia Federal no Acre sendo __Chefe do Núcleo de Tecnologia da Informação__ de 2012-até hoje além de ser __Chefe da CS__ do mesmo órgão (Comunicação Social) de 2012 até hoje. 
* **Atualmente é Professor** das disciplinas de __Estrutura de Dados__, __Linguagem de Programação__, __Programação Orientada a Objetos__, __POO para a Web__, __Matemática e Lógica para Computação__, __Empreendedorismo__, __Gestão de TI__ e __Fundamentos de Programação e Algoritmos__ no Centro Universitário UNINORTE nos cursos de **Sistemas de Informação**, **CST em Redes de Computadores** e **CST em Estética e Cosmética** (além de já ter ministrado no mesmo Centro universitário, em 2007, as disciplinas de __Algoritmos__ e __Álgebra Relacional__). 
* *Tem experiência* na área de *Ciência da Computação*, com ênfase em *Sistemas de Informação, Programação, Algoritmos, Estruturas de Dados, Matemática e Complexidade Computacional*. 
...
* Tem *bastante experiência* em **didática** sendo professor há mais de duas décadas (e de nível superior desde 2007). 
* Já foi professor, durante esse período, de **Informática, Matemática, História, Redação, Organização de Empresas, Inglês, Programação, Algoritmos e Álgebra, Webdesign com habilitação em HTML, Dreamweaver, Flash, Fireworks e Publicação na Web** além de professor das disciplinas de **Introdução ao Processamento de Dados, Organização de Empresas, Inglês Técnico e Informáticas Básica e Avançada** do __*Curso Técnico em Manutenção e Hardware da Contil Informática*__. 
* Possui *Conhecimento e experiência* em **implantação/gerenciamento (remoto e console) de soluções corporativas em ambiente Windows baseadas no Active Directory, incluindo o gerenciamento/manutenção e consolidação do domínio local da Polícia Federal-Acre** (2011-2013). 
* *Possui conhecimento* (prático e didático) e experiência nas linguagens de Programação: **C/C++, Java, C#, Python (e Django), Ruby (e Rails), VBA - Visual Basic for Applications, Delphi, Visual Basic e PHP**, além de __conhecimentos avançados__ de **Linux, HTML/CSS, Javascript, XML e Json, e Design** desenvolvendo *soluções acadêmicas, profissionais e práticas em todas as linguagens citadas* sendo, portanto, desenvolvedor "full stack". 

### Prêmios recebidos e menções profissionais

* **__Vencedor__**, juntamente com a equipe de desenvolvedores e programadores/Analistas do CGTI/SEJUSP do *__1º e 2º lugares__*, do **__1º Prêmio Inovação de Gestão do Estado do Acre na Área Tecnologia da Informação e Atendimento ao Cidadão__**, respectivamente. O prêmio é outorgado às melhores soluções em TI no governo do Acre. A premiação foi: Em primeiro lugar o __Sistema Integrado de Notícias-Crime__ (para manutenção de ocorrências policiais e análise) e em segundo lugar a Delegacia Virtual para registro de ocorrências policiais pela Web. (2005/2006). 
* **__Vencedor__**, junto com a equipe de programadores/Analistas do CGTI/SEJUSP em 1º lugar, do **__2º Prêmio Inovação de Gestão do Estado do Acre na Área Tecnologia da Informação e Atendimento ao Cidadão__** para o Sistema PIC - Pedido de Identificação Criminal. (2006/2007). O prêmio é outorgado às melhores soluções em TI no governo do estado do Acre.
...
### Grau de Instrução
*	Mestrado em andamento em Ciência da Computação. Universidade Federal do Acre, UFAC, Brasil. Projeto: *“Mineração de dados e aprendizagem de máquina na detecção de conflitos diretos e indiretos entre políticas de controle de acesso”*
*	Mestrado em Informática pela UFAM (Universidade Federal do Amazonas – Conceito CAPES 5 – Incompleto)
*	Pós-graduado, lato sensu, em Computação Forense. (Carga Horária: 360h). Faculdade Barão do Rio Branco, UNINORTE, Brasil. Título da Monografia: *“Perícia Forense em sistemas GNU/LINUX usando programação em shell script”.* Orientadora: [Dra. Andreia Cristiane Stanger. 2013-2015.](http://buscatextual.cnpq.br/buscatextual/visualizacv.do?id=K4732443D0)
...
*	Atualmente exercendo o cargo de Policial Federal (Agente de Polícia Federal) na Superintendência Regional da Polícia Federal no Acre sendo atualmente Chefe do NTI, Núcleo de Tecnologia da Informação, de 2012-até hoje e Chefe da CS (Comunicação Social de 2012 até hoje) tendo sido lotado durante 03 anos em Epitaciolândia-AC onde trabalhei com Repressão à Entorpecentes, Imigração, Segurança Privada, Serviços Institucionais (Armas, Eleições) e Análise Criminal.  (segundo semestre de 2007 até hoje).
*	Atualmente exercendo o cargo de Professor, de nível superior, das disciplinas “Estatística” (1º período), “Estruturas de Dados” (4º período de Sistemas de Informação-SI), Matemática e Lógica para Computação (3º período de Sistemas de Informação e CST em Redes de Computadores), Programação Orientada a Objetos (4º período de SI), Programação Orientada a Objetos para a Web (6º período de SI), Empreendedorismo (3º período de SI; 8º período de Estética e Cosmética e CST em Redes e 8ª período de SI) e “Linguagem de Programação” (3º período de SI e Redes) do Curso de Bacharel em Sistemas de Informação e do curso de CST em Redes de Computadores do Centro Universitário UNINORTE em Rio Branco, Acre. (2012 até hoje)
