...
* **Atualmente exerço o cargo de Policial Federal** (*Agente de Polícia Federal*) na Superintendência da Polícia Federal na Paraíba sendo __Chefe do Núcleo de Tecnologia da Informação__ de 2024-até hoje (tendo sido substituto de 2023 a 2024) além de ser __chefe_substituto__ da __Comunicação Social__ do mesmo órgão (CS) desde 2023 até hoje.
...
1. **LIMA, E. S.** Aplicação de Mineração de Dados e Aprendizagem de Máquina na Detecção de Conflitos Diretos entre Políticas de Controle de Acesso. Janeiro de 2021. (Tese de Mestrado). [Link para o texto completo](https://www.researchgate.net/publication/383823025_Aplicacao_de_Mineracao_de_dados_e_Aprendizagem_de_Maquina_na_deteccao_de_conflitos_diretos_entre_politicas_de_controle_de_acesso_Application_of_Data_Mining_and_Machine_Learning_in_the_detection_of_dir).


2. **SILVA, M. ; OLIVEIRA, A. ; VIEIRA, V. ; LIMA, E. S. Problemas Matemáticos de Xadrez: Caracterizando o Problema de Dominação.** 2017 (Artigo publicado em coautoria). [Link para o artigo](https://www.researchgate.net/publication/301282933_Problemas_Matematicos_de_Xadrez_Caracterizando_o_Problema_de_Dominacao)



3. **LIMA, E. S.** Os Desenvolvedores Realmente Usam Testes no Desenvolvimento Ágil? Maio de 2018. (Artigo publicado em coautoria). [Link para o artigo](https://www.researchgate.net/publication/383823073_Os_desenvolvedores_realmente_usam_testes_no_desenvolvimento_agil_Do_developers_really_use_testing_in_agile_distributed_development_A_survey).
